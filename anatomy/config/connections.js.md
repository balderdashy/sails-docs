...
This file lets you create different global "saved settings" that you can mix and match in your models. The [`sails.models.connection`](http://sailsjs.com/documentation/anatomy/config/models.js) option indicates which connection should be used if a model doesn't have one [explicitly specified](https://sailsjs.com/documentation/concepts/models-and-orm/model-settings#?connection).
...
module.exports.connections = {
  ...
  //
  // Run:
  // npm install sails-mysql@for-sails-0.12 --save
  //
  someMysqlServer: {
    adapter: 'sails-mysql',
  ...
  //
  // Run:
  // npm install sails-mongo@for-sails-0.12 --save
  //
  someMongodbServer: {
    adapter: 'sails-mongo',
    host: 'localhost',
  ...
  //
  // Run:
  // npm install sails-postgresql@for-sails-0.12 --save
  //
