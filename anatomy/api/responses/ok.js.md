...
Il contient la logique de ce qui devrait se produire lorsque vous souhaitez émettre une réponse http 200. La réponse peut être émise à partir de n'importe quel endroit où vous avez accès à l'objet express `res` en appelant res.ok.
