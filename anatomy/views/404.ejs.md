...
Il s'agit de la page "404: Not Found" par défaut. Les agents web qui n'acceptent pas HTML verront une version JSON à la place. Vous pouvez personnaliser la logique de contrôle pour vos besoins dans `config / 404.js`.

Sails considère qu'une requête a le statut "404: Not Found" lorsqu'un utilisateur demande une URL qui ne correspond à aucun des routes ou des blueprints de votre application.

Vous pouvez également déclencher cette réponse à partir de l'un de vos contrôleurs ou stratégies avec : `Return res.notFound ();`
...
<html>
  <head>
    ...
    <link href='http://sailsjs.com/styles/fonts.css' rel='stylesheet'/>
    <style>
  ...
  <body>
    ...
    <div class="fourohfour">
      <div class="ocean">
        <img class="fishy" src="http://sailsjs.com/images/fishy4.png">
      </div>
      ...
      <div class="logo">
        <a href="http://sailsjs.com">
          <img src="http://sailsjs.com/images/logo.png">
        </a>
      </div>
    </div>
