...
Sails considère qu'une requête a l'état "404: Not Found" lorsqu'un utilisateur demande une URL qui ne correspond à aucun des routes ou des blueprints de votre application.
