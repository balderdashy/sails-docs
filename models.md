...
Associations are not yet available for Sails.JS, however are on the immediate todo list.  Please check out issue [#124][internal-ref] for more information regarding the proposed changes for associations.
