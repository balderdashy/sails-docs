...
Associations are not yet available for Sails.JS, however are on the immediate todo list.  Please check out issue [#124](issues/124) for more information regarding the proposed changes for associations.
