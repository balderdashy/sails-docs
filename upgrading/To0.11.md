...
+ if you were using other low-level socket configuration that was passed directly to socket.io v1, be sure and check out the [reference page on sailsjs.com](http://sailsjs.com/#!/documentation/reference/configuration/sails-config-sockets) where all of the new configuration options are covered in detail.
...
You can read more about how to write your own hooks in the [new and improved "Extending Sails" documentation](http://sailsjs.com/#!/documentation/concepts/extending-sails) on http://sailsjs.com.
