...
This is another special type of class method.  It stands for 'Publish, Subscribe' and thats just what they do. These methods play a big role in how Sails integrates and utilizes Socket.IO .  They are used to subscribe clients to and publish messages about the creation, update, and destruction of models.  If you want to build real-time functionality in Sails, these will come in handy.  See the heavily-annotated [sailsChat app](https://github.com/balderdashy/sailsChat) for an example of using PubSub and sockets to implement real-time chat functionality.
