...
|---|----------------|:-----------:|---------|
| 1 | `status`       | ((integer)) |  (optional) a positive integer that corresponds to an [HTTP status code](http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html)|
...
> + If you want to send a custom status code(e.g. 301) along with a redirect, you can do the following: `return res.redirect(301, '/foo');`
