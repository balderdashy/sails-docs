...
|---|:--------------------------- | ------------------- |:-----------
| 1 |        roomNames              | ((string)), ((Array))          | The name of one or more rooms to broadcast a message in (see [sails.sockets.join](http://sailsjs.com/documentation/reference/web-sockets/sails-sockets/sails-sockets-join)).  To broadcast to individual sockets, use their IDs as room names.
