...
Configuration for Sails' built-in internationalization & localization features.  By convention, this is set in `config/i18n.js`, from where you can set your supported locales. For more information see the [concepts section on internationalization](http://sailsjs.org/documentation/concepts/Internationalization).
