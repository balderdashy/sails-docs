...
skipDecryption             | ((boolean)) | false    | Set to `true` to fetch records with data that is still encrypted by Sails' built-in [at-rest encryption](https://github.com/balderdashy/sails-docs/blob/fb6acb9558124d2f37ef258b0a9e2c497d32837b/PAGE_NEEDED.md) without automatically decrypting it.
