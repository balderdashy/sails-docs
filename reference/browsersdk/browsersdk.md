...
Fortunately, like every other boilerplate file and folder in Sails, the socket client is completely optional. To remove it, just delete [`assets/js/sails.io.js`]().
...
<docmeta name="displayName" value="Browser Socket (`sails.io.js`)">
