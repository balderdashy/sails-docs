...
For convenience, Sails bundles special support for layouts **when using the default view engine, EJS**. If you'd like to use layouts with a different view engine, check out [that view engine's documentation](/#/documentation/concepts/Views/ViewEngines.html) to find the appropriate syntax.
