...
Using the `where` key allows you to also use [criteria clauses](https://sailsjs.com/documentation/concepts/models-and-orm/query-language#?criteria-clauses), such as `limit`, `skip`, and `sort`.
