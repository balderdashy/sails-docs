...
If you're looking for some inspiration, a good place to start is with the core adapters.  Take a look at **[MySQL](https://github.com/balderdashy/sails-mysql/tree/0.12.x)**, **[PostgreSQL](https://github.com/balderdashy/sails-postgresql/tree/for-sails-0.12)**, **[MongoDB](https://github.com/balderdashy/sails-mongo/tree/0.12.x)**, **[Redis](https://github.com/balderdashy/sails-redis)**, local [disk](https://github.com/balderdashy/sails-disk), or local [memory](https://github.com/balderdashy/sails-memory).
