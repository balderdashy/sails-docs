...
* Services cannot be saved independently of an app.  While some types of hooks may be tied to a single app (see [User Hooks](http://sailsjs.org/documentation/concepts/extending-sails/Hooks/userhooks.html)), other types can be developed independently of a Sails app and installed using `npm install`.
