...
2. **App-level hooks** live in the `api/hooks/` folder of a Sails app.  Project hooks let you to take advantage of the features of the hook system for code that doesn&rsquo;t need to be shared between apps.
