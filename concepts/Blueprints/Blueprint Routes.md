...
> + By default, in a new Sails app you'll need to provide or disable [CSRF tokens](https://next.sailsjs.com/documentation/concepts/security/csrf) for POST/PUT/DELETE actions, otherwise you will get a 403 Forbidden response.
