...
Read more about [configuring blueprints in Sails](http://sailsjs.com/documentation/reference/sails.config/sails.config.blueprints.html), including how to enable / disable different categories of blueprint routes.
