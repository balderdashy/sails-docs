...
> + By default, in a new Sails app you'll need to provide a [CSRF token](https://next.sailsjs.com/documentation/concepts/security/csrf) for POST/PUT/DELETE actions, otherwise you will get a 403 Forbidden response
