...
For convenience, Sails exposes its internal logging interface as `sails.log`.  Its usage is functionally very similar to Node's `console.log()`, but with a handful of extra features, namely support for multiple log levels with colorized, prefixed console output.
...
Useful for sharing important technical information amongst your team or as a general alternative to `console.log()`.
