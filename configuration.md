...
So, now you have Sails.js installed and it&rsquo;s loading up your awesome new project.  What? That&rsquo;s not good enough? Okay, let&rsquo;s see what we can configure to make it better suit your needs!
...
* <a href="https://github.com/balderdashy/sails-wiki/blob/0.9/config.local.md">local.js</a>               (This file is included in the `.gitignore` and won&rsquo;t be pushed up to your git repository.  It handles any LOCAL overrides needed)
