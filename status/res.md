...
The chart below describes support for the methods and properties on the Sails [Response](http://sailsjs.com/documentation/reference/res) object (`res`) across multiple transports:
